...
2. Message the CEO with your project idea
...
- **Agent Sessions**: you can chat with any agent, or just interact with the CEO

You can always ask the CEO to "hire" new agents, but its recommended to create the first ones yourself.
...
## Step 2: Message the CEO to begin

In the left sidebar, under **Agents & Sessions**, click **CEO**.

The CEO will ask you about your project, will plan it, and break it down into smaller tasks.

## Step 3: Follow the work as it gets organized

Once the CEO starts, OpenGoat turns the plan into execution:

- tasks get created and assigned
- agents start working on their tasks one by one
- the CEO will delegate tasks accordingly to the organization size
