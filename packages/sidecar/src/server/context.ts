import type { ArtifactService, BoardService, MemoryService, MessagingConnectionService, MessagingRouterService, ObjectiveService, OpenGoatPaths, PlaybookExecutionService, PlaybookRegistryService, RunService, SignalService, SkillService, TelegramChannelService, WhatsAppChannelService } from "@opengoat/core";
