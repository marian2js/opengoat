...
If PRODUCT.md, MARKET.md, and GROWTH.md exists (or PRODUCT.md, MARKET.md, and GROWTH.md in older setups), read it before editing. Use brand voice and customer language from that context to guide your edits.
