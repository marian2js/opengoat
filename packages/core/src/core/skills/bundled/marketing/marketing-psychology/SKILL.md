...
If PRODUCT.md, MARKET.md, and GROWTH.md exists (or PRODUCT.md, MARKET.md, and GROWTH.md in older setups), read it before applying mental models. Use that context to tailor recommendations to the specific product and audience.
