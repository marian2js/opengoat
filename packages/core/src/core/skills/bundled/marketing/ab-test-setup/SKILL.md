...
Use that context and only ask for information not already covered. Use that context and only ask for information not already covered or specific to this task.
